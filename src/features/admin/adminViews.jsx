...
export function ProductsView() {
  const { getAllProducts, deleteProduct, getInventoryStats, initProducts } = useProductsStore()
...
export function VendorsView({ highlightedApplicationId = null, onClearHighlight }) {
